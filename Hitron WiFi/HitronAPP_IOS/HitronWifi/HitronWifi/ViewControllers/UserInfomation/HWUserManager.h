 ...
 */
- (void) doUserLogoutWith:(NSString *)userID Mac:(NSString *)mac Sucess:(void (^)(BOOL result))success Failure:(void (^)(NSError *err))failure;

- (void) doUserLogoutSucess:(void (^)(BOOL result))success Failure:(void (^)(NSError *err))failure;
