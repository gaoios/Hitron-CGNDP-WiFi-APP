...
#import "HWScanQRCodeViewController.h"

@import AVFoundation;

@interface HWScanQRCodeViewController () <AVCaptureMetadataOutputObjectsDelegate>

@property (nonatomic, assign) CGRect scanRect;

@end

@implementation HWScanQRCodeViewController
